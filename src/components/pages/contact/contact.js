...
export function Contact(){
    ...
    const buttonHandler = () => {
        ReactGA.event({
            category: 'Button',
            action: 'Clicked on a contact button'
        })
    }
            ...
            <div className="contact-header-container">
                ...
                <div className="contact-right-column">
                    ...
                    <div className="contact-options">
                        <a onClick={buttonHandler} href="mailto:sebamontagna@gmail.com" target="_blank"><i className="far fa-envelope"></i></a>
                        <a onClick={buttonHandler} href="https://github.com/sebamont" target="_blank"><i className="fab fa-github"></i></a>
                        <a onClick={buttonHandler} href="https://www.linkedin.com/in/sebastian-montagna/" target="_blank"><i className="fab fa-linkedin"></i></a>
                        <a onClick={buttonHandler} href="https://twitter.com/Seba_mont/" target="_blank"><i className="fab fa-twitter"></i></a>
                        <a onClick={buttonHandler} href="tel:+543875423222" target="_blank"><i className="fab fa-whatsapp"></i></a>
                    </div>
                </div>

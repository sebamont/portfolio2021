        ...
        <motion.div className="contact-container" exit={pageTransition.out} initial={pageTransition.out} animate={pageTransition.in} transition={PageTransitionDurations}>
            <div className="contact-header-container">
                ...
                <div className="contact-right-column">
                    <h2 className="arcade-font">Thank you for passing by</h2>
                    <p>If you'd like to contact me, whether it is about a Job located in Salta or Cordoba (ARG), a Remote Job, a Freelance Job, or just because you felt like it, you can find me in</p>     
